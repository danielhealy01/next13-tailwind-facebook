    ...
    <Card noPadding={true}>
      <div className="px-4 py-2 justify-between flex md:block shadow-md shadow-gray-500 md:shadow-none">
        ...
        <Link
          ...
          className={
            pathname === "/profile/friends" ? activeElement : inActiveElement
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          href="/Saved"
          className={pathname === "/Saved" ? activeElement : inActiveElement}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <Link
          href="/Notifications"
          className={
            pathname === "/Notifications" ? activeElement : inActiveElement
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
